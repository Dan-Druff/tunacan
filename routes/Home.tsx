...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 440" width="400" height="440">
  ...
  <section class="shows" id="shows">
    ...
    <div class="shows-grid reveal">
      <div class="show-card">
        <span class="show-price">$10-$20??</span>
      ...
      <div class="show-card">
        <span class="show-price">$TBD</span>
        <p class="show-date">TBD</p>
        <h3 class="show-name">Sardine Saturdays</h3>
        <p class="show-venue">TBD</p>
        <div class="show-tags">
  ...
  <section class="about" id="about">
    ...
    <div class="about-right">
      ...
      <div class="about-quote">
        ...
        <p class="quote-text">The most hilarious comedy nights in the city. Every single time.</p>
  ...
  <section class="performers" id="performers">
    ...
    <div class="performers-grid reveal">
      <div class="performer-card">
        ...
        <p class="performer-name">Marcus "Fin" Reyes</p>
      ...
      <div class="performer-card">
        ...
        <p class="performer-name">Dina Kowalski</p>
        <p class="performer-style">Story-telling · Dark Humor</p>
      </div>
      <div class="performer-card">
        ...
        <p class="performer-name">T-Bone Calloway</p>
      ...
      <div class="performer-card">
        ...
        <p class="performer-name">Rosa Chen</p>
  ...
  <footer>
    <div class="footer-brand">
      ...
      <p class="footer-tagline">Sorta funny. Live comedy production done right.</p>
    </div>
